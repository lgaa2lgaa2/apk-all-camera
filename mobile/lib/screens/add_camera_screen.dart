      ...
      builder: (context) => const SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Recherche terminée', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
              SizedBox(height: 8),
              Text(
                'La détection automatique ONVIF/RTSP est maintenant prévue dans l’interface. Le moteur réseau réel sera branché ici pour identifier IP, ports et profils vidéo compatibles.',
                style: TextStyle(color: Color(0xFF91A4BB)),
              ),
            ],
          ),
        ),
...
class _ManualCameraForm extends StatefulWidget {
  const _ManualCameraForm({required this.family});
  final String family;
